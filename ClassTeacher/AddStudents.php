...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName', admissionNumber='$admissionNumber',password='12345', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Course Section<span class="text-danger ml-2">*</span></label>
                            <?php
